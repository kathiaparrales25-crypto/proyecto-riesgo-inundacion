...
Las predicciones se generaron con **Regresión Logística**, el modelo con mejor Recall (0.77) entre los cuatro evaluados (ver informe del proyecto). `app.py` solo lee el CSV ya calculado, no ejecuta el modelo en cada petición.
