...
app.py combina el GeoJSON con el CSV de predicciones, emparejando por código de parroquia (DPA_PARROQ - 
codigo_parroquia). 
...
los_rios.geojson y predicciones_parroquias.csv desde la carpeta data/.
